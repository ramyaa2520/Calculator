Welcome to my Simple Calculator project — a basic web application that performs standard arithmetic operations: addition, subtraction, multiplication, and division.
